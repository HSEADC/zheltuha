...
/* harmony export */   "y": () => (/* binding */ getPostTeasers)
/* harmony export */ });
...
var token = 'patbP1eWzjFM6gS7p.d7584839fbca541c5df569feb033408483968ffda849bd24ebb62c618e3a3cb3';
airtable__WEBPACK_IMPORTED_MODULE_0___default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable__WEBPACK_IMPORTED_MODULE_0___default().base('appNiUySinRMOUjzR');

function getPostTeasers() {
  return new Promise(function (resolve, reject) {
    var content = [];
    base('zheltuha').select({
      maxRecords: 100
...
var A_search = function A_search(_ref) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (A_search);
...
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ S_SearchContent_S_SearchContent)
});

// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(294);
;// CONCATENATED MODULE: ./src/components/M_card/M_card.jsx


var M_card = function M_card(_ref) {
  ...
  return /*#__PURE__*/react.createElement("a", {
    ...
    className: "M_commons_teg for_cards"
  }, tags.map(function (tag, index) {
    return /*#__PURE__*/react.createElement("div", {
      key: index,
      className: "A_commons_teg p3"
    }, tag);
  })), /*#__PURE__*/react.createElement("p", null, description));
};

/* harmony default export */ const M_card_M_card = (M_card);
// EXTERNAL MODULE: ./src/js/searchdata.js
var searchdata = __webpack_require__(392);
// EXTERNAL MODULE: ./src/components/A_search/A_search.jsx
var A_search = __webpack_require__(274);
...
var S_SearchContent = function S_SearchContent() {
  ...
  var _useState3 = (0,react.useState)([]),
      ...
      filteredTeasers = _useState4[0],
      setFilteredTeasers = _useState4[1];

  var _useState5 = (0,react.useState)(''),
      _useState6 = _slicedToArray(_useState5, 2),
      searchInputValue = _useState6[0],
      setSearchInputValue = _useState6[1];

  (0,react.useEffect)(function () {
    (0,searchdata/* getPostTeasers */.y)().then(function (data) {
      setPostTeasers(data);
  ...
  var filterTeasers = function filterTeasers(teasers, query) {
    console.log(query);
    var lowercasedQuery = query.toLowerCase();
    var nbspRegex = /[\u202F\u00A0]/gm;
    var punctuationRegex = /[.,\/#!$%\^&\*;:{}=\-_~()]/gm;
    var filtered = teasers.filter(function (teaser) {
      var title = teaser.title.replace(nbspRegex, ' ').replace(punctuationRegex, '').toLowerCase();
      var description = teaser.description.replace(nbspRegex, ' ').replace(punctuationRegex, '').toLowerCase();
      var titleMatches = title.includes(lowercasedQuery);
      var descriptionMatches = description.includes(lowercasedQuery);
      var tagMatches = teaser.tags.some(function (tag) {
        var tagDescription = tag.replace(nbspRegex, ' ').replace(punctuationRegex, '').toLowerCase();
  ...
  var handleFindButtonClick = function handleFindButtonClick() {
    setSearchInputValue(value);
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: "M_search"
  }, /*#__PURE__*/react.createElement(A_search/* default */.Z, {
    onEnter: handleSearchInputChange
  })), /*#__PURE__*/react.createElement("div", {
    className: "O_cards"
  }, filteredTeasers.map(function (teaser) {
    return /*#__PURE__*/react.createElement(M_card_M_card, {
      title: teaser.title,
...
/* harmony default export */ const S_SearchContent_S_SearchContent = (S_SearchContent);
...
/* harmony import */ var _components_S_SearchContent_S_SearchContent_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(378);



document.addEventListener('DOMContentLoaded', function () {
  var container = document.querySelector('.O_search');
  var root = (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__/* .createRoot */ .s)(container);
  root.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_S_SearchContent_S_SearchContent_jsx__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, null));
});
})();
